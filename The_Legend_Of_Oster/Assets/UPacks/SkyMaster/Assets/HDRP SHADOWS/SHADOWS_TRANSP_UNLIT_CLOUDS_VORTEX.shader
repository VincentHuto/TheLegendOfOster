Shader "HDRP SHADOWS SM CLOUDS_VORTEX"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //-------------------------------------------------------------------------------------
                    ...
                    CBUFFER_END
                    TEXTURE2D(Texture2D_5343010B); SAMPLER(samplerTexture2D_5343010B); float4 Texture2D_5343010B_TexelSize;
                    SAMPLER(_SampleTexture2D_FCFCA997_Sampler_3_Linear_Repeat);
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _SampleTexture2D_FCFCA997_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_5343010B, samplerTexture2D_5343010B, IN.uv0.xy);
                        float _SampleTexture2D_FCFCA997_R_4 = _SampleTexture2D_FCFCA997_RGBA_0.r;
                        float _SampleTexture2D_FCFCA997_G_5 = _SampleTexture2D_FCFCA997_RGBA_0.g;
                        float _SampleTexture2D_FCFCA997_B_6 = _SampleTexture2D_FCFCA997_RGBA_0.b;
                        float _SampleTexture2D_FCFCA997_A_7 = _SampleTexture2D_FCFCA997_RGBA_0.a;
                        float _Property_F53F7D2D_Out_0 = Vector1_4F56884;
						...
						//v0.7a - VORTEX
						//float4 vortexPosRadius = float4(0, 0, 0, 1000);
						float distanceToVortexCenter = length(vortexPosRadius.xz - woeldPos.xz);
						...
						float3 posVertexA = float3(woeldPos.x, 0, woeldPos.z);// vortexPosRadius;
						posVertexA = posVertexA - vortexPosRadius;
						float3 posVertex = mul(posVertexA, rotator);

						posVertex.y = woeldPos.y;
                        ...
                        //surface.Alpha = _SampleTexture2D_FCFCA997_A_7;
                        //surface.AlphaClipThreshold = _Property_F53F7D2D_Out_0;
                        return surface;
                    }
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _SampleTexture2D_FCFCA997_A_7 = _SampleTexture2D_FCFCA997_RGBA_0.a;
                        float _Property_F53F7D2D_Out_0 = Vector1_4F56884;
                        surface.Color = (_SampleTexture2D_FCFCA997_RGBA_0.xyz);
                        surface.Alpha = _SampleTexture2D_FCFCA997_A_7;
                        surface.AlphaClipThreshold = _Property_F53F7D2D_Out_0;
