...
Shader "SkyMaster/SnowShaderSM4a URP" {
	Properties{
	...
	//[LM_Specular][LM_Glossiness] _SpecGlossMap2("Specular 1", 2D) = "white" {}
		...
		Tags{ "RenderType" = "UniversalPipeline" "Queue" = "Geometry+501"}
		//Blend SrcAlpha OneMinusSrcAlpha
		Cull Off
		//Lighting Off
		Zwrite On
		//Tags{ "RenderType" = "UniversalPipeline" "Queue" = "Geometry"}
		////Blend SrcAlpha OneMinusSrcAlpha
		//Cull Off
		////Lighting Off
		//Zwrite On
