...
Shader "SkyMaster/Cloud Dome ADD" {
    Properties {
...
//          }
 ...
 //fixed Bumped_lightingN = dot( UnpackedN, i.dir);
		...
		return saturate(res) - float4(_Brightness.x, _Brightness.y, _Brightness.z, 0);// -float4(_Brightness.x, _Brightness.x, _Brightness.x, 0);// float4(0.5, 0.5, 0.5, 1);
    }
    ENDCG 
