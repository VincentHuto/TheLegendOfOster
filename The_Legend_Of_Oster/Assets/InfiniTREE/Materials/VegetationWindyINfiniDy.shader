...
/////// Normals:
                float2 node_606 = i.uv0;
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_606.rg, _Normal))).rgb;
                ...
                float4 node_1 = tex2D(_Diffuse,TRANSFORM_TEX(node_606.rg, _Diffuse));
                clip(node_1.a - 0.5);
                #ifndef LIGHTMAP_OFF
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_607.rg, _Normal))).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
                ...
                float4 node_1 = tex2D(_Diffuse,TRANSFORM_TEX(node_607.rg, _Diffuse));
                clip(node_1.a - 0.5);
...
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_1 = tex2D(_Diffuse,TRANSFORM_TEX(node_608.rg, _Diffuse));
                clip(node_1.a - 0.5);
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_1 = tex2D(_Diffuse,TRANSFORM_TEX(node_609.rg, _Diffuse));
                clip(node_1.a - 0.5);
