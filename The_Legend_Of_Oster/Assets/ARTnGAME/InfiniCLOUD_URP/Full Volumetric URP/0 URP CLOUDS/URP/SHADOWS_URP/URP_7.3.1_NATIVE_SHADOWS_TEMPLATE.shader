...
Shader "Universal Render Pipeline/Custom/Physically Based Example SHADOWS"
{
	Properties
	{
...
#include "Packages/com.unity.render-pipelines.universal/Shaders/LitInput.hlsl"
	...
	struct Varyings
	{
		...
		half3 bitangentWS               : TEXCOORD5; //#if defined(REQUIRES_VERTEX_SHADOW_COORD_INTERPOLATOR) //v0.1
#endif
	...
	Varyings LitPassVertex(Attributes input)
	{
		...
		output.bitangentWS = vertexNormalInput.bitangentWS; //#if defined(REQUIRES_VERTEX_SHADOW_COORD_INTERPOLATOR) v0.1
#endif
	...
	// computed.
	///Light mainLight = GetMainLight(input.shadowCoord); v0.1
	float4 shadowCoord;
	#if defined(REQUIRES_VERTEX_SHADOW_COORD_INTERPOLATOR)
