...
public class PlanarRefractionsSM_LWRP : MonoBehaviour//, IBeforeCameraRender
{
    [System.Serializable]
    ...
    public string refractionTextureName = "_RefractionTextureSM";
    ...
    private void OnEnable()
    {
        ...
        {
            UnityEngine.Rendering.Universal.UniversalAdditionalCameraData thisCameraData = m_ReflectionCamera.gameObject.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>();
    ...
    {
        GameObject go =
            new GameObject("Planar Refract Camera id" + GetInstanceID() + " for " + currentCamera.GetInstanceID(),
                typeof(Camera));
    ...
    public void DoReflections(ScriptableRenderContext context, Camera camera)
    {
        ...
        m_ReflectionCamera.transform.position = camera.transform.position;
        m_ReflectionCamera.transform.rotation = camera.transform.rotation;
