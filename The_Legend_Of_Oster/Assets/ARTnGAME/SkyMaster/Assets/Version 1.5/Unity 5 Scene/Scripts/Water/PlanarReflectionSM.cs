...
namespace Artngame.SKYMASTER
{
    ...
    public class PlanarReflectionSM : MonoBehaviour
    {
        ...
        public void LateUpdate()
        {
            ...
            if (URPMode && Application.isPlaying)
            {
                this.enabled = false;
                Destroy(m_ReflectionCameraOut.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>());
                Destroy(m_ReflectionCameraOut);
            }
        }
