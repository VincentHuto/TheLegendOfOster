		...
		void OnGUI() {
			...
			if (Toggle_GUI) {
				...
				if (!OnlySunWind) {
                    ...
                    if (GUI.Button(new Rect(100 + 120, 10  + newOffset*2, 300, 25), "Toggle Around HERO Grass Planting - Erasing"))
                    {
                        if (heroPlanter.enablePlanting)
                        {
                            heroPlanter.enablePlanting = false;
                            heroPlanter.Enable_real_time_erase = true;
                        }
                        else
                        {
                            heroPlanter.enablePlanting = true;
                            heroPlanter.Enable_real_time_erase = false;
                        }
                    }
                    //v1.9.9
                    //if (GUI.Button(new Rect(100 + 120, 10 + newOffset*2 + 30, 200, 25), "Toggle Around HERO erase"))
                    //{
                    //    if (heroPlanter.Enable_real_time_erase)
                    //    {
                    //        heroPlanter.Enable_real_time_erase = false;
                    //        heroPlanter.enablePlanting = true;
                    //    }
                    ...
                    //    }
                    //}
                    string plantingON = "MODE: ERASING GRASS";
                    //string erasingON = "OFF";
                    if (heroPlanter.enablePlanting)
                    {
                        plantingON = "MODE: PLANTING GRASS";
                    }
                    //if (heroPlanter.Enable_real_time_erase)
                    //{
                    //    erasingON = "ERASING GRASS";
                    //}
                    if (GUI.Button(new Rect(100 + 120, 10 + newOffset * 2 + 30*1, 300, 35), plantingON))
                    { }
